...
<body>
    ...
    <nav>
        <div id="cssmenu">
            <ul>
                <li><a href="principal_a.php"><span>Principal</span></a></li>
                <li class="has-sub"><a href="#"><span>Actualizar</span></a>
                    <ul>
                        <li><a href="actualizar.php"><span>Datos Personales</span></a></li>
                        <li><a href="actualizarimg_a.php"><span>Cambiar Foto de Perfil</span></a></li>
                        <li class="last"><a href="cambiarpass.php"><span>Cambiar Contraseña</span></a></li>
                    </ul>
                </li>
                <li class="has-sub"><a href="#"><span>Proyecto</span></a>
                    <ul>
                        <li><a href="verproyecto.php"><span>Mis Proyectos</span></a></li>
